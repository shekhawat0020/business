...
<div class="app-content">
    <div class="side-app">
        ...
        <!--  Start Content -->
    <form id="submitForm" class="row"  method="post" action="{{route('store-store')}}">
        {{csrf_field()}}
        <!-- COL END -->
							<div class="col-lg-6">
								<div class="card">
            ...
            $.ajax({
                ...
                success: function(data) {
                    if(data.status){
                        ...
                        successMsg('Create Store', data.msg, btn);
                        $('#submitForm')[0].reset();
                        ...
                        errorMsg('Create Store','Input error');
                    }
                    buttonLoading('reset', $this);
                    
                },
                error: function() {
                    errorMsg('Create Store', 'There has been an error, please alert us immediately');
                    buttonLoading('reset', $this);
                }
