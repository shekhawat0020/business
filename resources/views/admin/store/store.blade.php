                    ...
                    <div class="card-header">
                        ...
                        <div class="ml-auto pageheader-btn">
							...
							<div class="form-group pull-left" style="margin-right: 10px;">
								...
								<a href="{{ route('store-create') }}" class="btn btn-success btn-icon text-white mr-2 create-link">
									<span>
        ...
        $(function () {
            ...
            var table = $('.data-table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'business_detail.business_name', name: 'business_detail.business_name'},
