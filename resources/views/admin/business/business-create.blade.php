...
@section('breadcrum')
<h1 class="page-title">Create Business</h1>
<ol class="breadcrumb">
...
<div class="app-content">
    <div class="side-app">
        ...
        <!--  Start Content -->
    <form id="submitForm" class="row"  method="post" action="{{route('business-store')}}">
        {{csrf_field()}}
        <!-- COL END -->
							<div class="col-lg-6">
								<div class="card">
            ...
            $.ajax({
                ...
                success: function(data) {
                    if(data.status){
                        ...
                        successMsg('Create Business', data.msg, btn);
                        $('#submitForm')[0].reset();
                        ...
                        errorMsg('Create Business','Input error');
                    }
                    buttonLoading('reset', $this);
                    
                },
                error: function() {
                    errorMsg('Create Business', 'There has been an error, please alert us immediately');
                    buttonLoading('reset', $this);
                }
